...
class Product(models.Model):
    ...
    product_image=  models.ImageField(upload_to='Store/%y/%m/%d',null=True,blank=True)
    product_image2= models.ImageField(upload_to='Store/%y/%m/%d',null=True,blank=True)
    product_image3= models.ImageField(upload_to='Store/%y/%m/%d',null=True,blank=True)
    product_image4= models.ImageField(upload_to='Store/%y/%m/%d',null=True,blank=True)
